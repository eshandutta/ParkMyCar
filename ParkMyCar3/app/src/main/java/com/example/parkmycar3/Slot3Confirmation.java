...
public class Slot3Confirmation extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slot3_confirmation);
        ...
        databaseReference=db.getReference("Slot3Db");
        ...
        dateTimePick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog=new DatePickerDialog(Slot3Confirmation.this,Slot3Confirmation.this,year,month,day);
        ...
        savebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if (!TextUtils.isEmpty(dataFieldVehicleNumber)&&!TextUtils.isEmpty(dataFieldCustName)&&!TextUtils.isEmpty(dataFieldMobileNumber)&&!dataFieldDay.equals("0"))
                {
                    ...
                    Toast.makeText(Slot3Confirmation.this,"data saved",Toast.LENGTH_SHORT).show();
    ...
    public void onDateSet(DatePicker datePicker, int i, int i1, int i2)
    {
        ...
        TimePickerDialog timePickerDialog=new TimePickerDialog(Slot3Confirmation.this,Slot3Confirmation.this,hour,minute, DateFormat.is24HourFormat(this));
    ...
    {
        DatabaseReference dR=FirebaseDatabase.getInstance().getReference("Slot3Db").child(id);
        dR.removeValue();

...
public class Slot1Confirmation extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_slot1_confirmation);
        ...
        databaseReference=db.getReference("Slot1Db");
        ...
        dateTimePick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog=new DatePickerDialog(Slot1Confirmation.this,Slot1Confirmation.this,year,month,day);
        ...
        savebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if (!TextUtils.isEmpty(dataFieldVehicleNumber)&&!TextUtils.isEmpty(dataFieldCustName)&&!TextUtils.isEmpty(dataFieldMobileNumber)&&!dataFieldDay.equals("0"))
                {
                    ...
                    Toast.makeText(Slot1Confirmation.this,"data saved",Toast.LENGTH_SHORT).show();
        ...
        cancelbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cancelBooking("PARSLOT1");
                showDateTime.setText("BOOKING CANCELLED !!");
            }
        });
        //----------------------------------------------------------------------------------------------------------

       /* vehicleNumber.addTextChangedListener(BookingTextWatcher);
        mobileNumber.addTextChangedListener(BookingTextWatcher);
        custName.addTextChangedListener(BookingTextWatcher);
        dateTimePick.addTextChangedListener(BookingTextWatcher);*/
    ...
    public void onDateSet(DatePicker datePicker,int i,int i1,int i2)
    {
        ...
        TimePickerDialog timePickerDialog=new TimePickerDialog(Slot1Confirmation.this,Slot1Confirmation.this,hour,minute, DateFormat.is24HourFormat(this));
    ...
    {
        DatabaseReference dR=FirebaseDatabase.getInstance().getReference("Slot1Db").child(id);
        dR.removeValue();
  ...
  /*  public void sendData()
    {
        String dataFieldVehicleNumber = vehicleNumber.getText().toString();
        String dataFieldMobileNumber = mobileNumber.getText().toString();
        String dataFieldCustName = custName.getText().toString();
        //String id = databaseReference.push().getKey();
        String id = "eshan";
        if (!TextUtils.isEmpty(dataFieldVehicleNumber))
        {
            Slot1Db data=new Slot1Db(dataFieldVehicleNumber,dataFieldMobileNumber,dataFieldCustName,id);
            databaseReference.child(id).setValue(data);
  ...
  private TextWatcher BookingTextWatcher=new TextWatcher() {
      ...
      public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        savebtn.setEnabled(!dataFieldCustName.isEmpty()&&!dataFieldVehicleNumber.isEmpty()&&!dataFieldMobileNumber.isEmpty()&&!dataFieldDay.isEmpty()&&dataFieldMonth.isEmpty()&&!dataFieldYear.isEmpty()&&!dataFieldHour.isEmpty()&&!dataFieldMinute.isEmpty());
